...
this.renderQuestion()
    ...
    nextQuestion = ()=>{
        const checkElement = this.questions[this.answeredAmount].answeredElements.filter((ele)=>ele.firstChild.checked)
    ...
    endQuizApp = ()=>{
        ...
        const correct = this.countAnsweredQuestios()
        new Final (correct,this.totalAmount)
    }
    countAnsweredQuestios = ()=>{
        let count = 0;
